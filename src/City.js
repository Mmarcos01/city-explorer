  ...
  render() {
    return (
      ...
      <button onClick={this.props.showSearch}>Enter a new city</button> 
        ...
        <img src={`https://maps.locationiq.com/v3/staticmap?key=${process.env.REACT_APP_LOCATIONIQ_KEY}&center=${this.props.displayData.lat},${this.props.displayData.lon}&zoom=10`} alt="City Map" />
      </>
    )
  }
}
